...
* Շփոթեցնող է 
  * Եթե բնօրինակ ֆայլը ջնջվի, hardlink-ը կշարունակի պահել տվյալները (և հակառակը)։ 
...
* Եզրակացություն
  * Symlink → Միշտ փորձել օգտագործել այս տարբերակը, եթե պահանջվում է "հղում" ֆայլին կամ դիրեկտորիային, քանի որ այս մեթոդը ճկուն է և ապահով:
