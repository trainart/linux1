...
* `Ctrl-U` – ջնջել տեքստը կուրսորից մինչև տողի սկիզբը
* `Ctrl-K` – ջնջել տեքստը կուրսորից մինչև տողի վերջը

#### Clear Terminal 

* `Ctrl-L` – մաքրել էկրանը - իրականում վերև տանել էկրանը (նույնն է, ինչ `clear` հրամանը)


* `reset` – կարգավորել էկրանը, եթե խառնվի նախորդ հրամաններից
...
### Info about command &  Manuals (man)

Գրեթե յուրաքանչյուր հրամանի վերաբերյալ հնարավոր է ստանալ տարբեր բացատրող տեղեկատվություններ:

* Ինչպես տեսանք հրամանի `--help` կամ `-h` ընտրանքները (options) տրամադրում են հակիրճ տեղեկատվություն:

* Կա նաև այլ տարբերակ `whatis`  
...
* Նաև այլ տեղեկություն կարելի է ստանալ `which` և `whereis` հրամաններով
...
* Եթե հրաման գրելուց առաջին սիմվոլը լինի բացատը, այդ հրամանը չի պահպանվի history-ում

Ցույց տալ վերջին 3 հրամանը

```bash
history 3
```
Կատարենք մի քանի հրաման:


Հետևյալ հրամանը չի պահպանվի history-ում

```bash
 uptime 
```

Իսկ սա կպահպանվի history-ում
...
Եթե ավելացնեն `-B`, ապա կստեղծվի նախորդ տարբերակի պահուստային պատճենը
...
Ստեղծել `alias`, որը թույլ կտա ամեն անգամ չավելացնել `nano` հրամանին `-B`
