...
* Հետևյալ հրամանով ստեղծել ՝~/largefile՝ ֆայլը, որտեղ կլինի 10000 համարակալված տող
```bash
seq 1 10000 > ~/largefile
```
* ՝~/largefile՝ ֆայլի համար 
  * ցուցադրել էկրանին միայն առաջին 8 տողերը
  * ցուցադրել էկրանին ՝~/largefile՝ ֆայլի միայն վերջին 5 տողերը
  * ցուցադրել էկրանին ՝~/largefile՝ ֆայլի միայն այն տողերը, որոնց մեջ կա `777` թիվը
    * լրացնել հրամանը, այնպես որ ստանանք, թե քանի՞ նման տող կա
  * ցուցադրել էկրանին ՝~/largefile՝ ֆայլի միայն այն տողերը, որոնց մեջ կա `77` թիվը հենց տողի սկզբում
    * լրացնել հրամանը, այնպես որ ստանանք, թե քանի՞ նման տող կա
  * ցուցադրել էկրանին ՝~/largefile՝ ֆայլի միայն այն տողերը, որոնց մեջ կա `77` թիվը տողի վերջում
    * լրացնել հրամանը, այնպես որ ստանանք, թե քանի՞ նման տող կա
  * ցուցադրել էկրանին ՝~/largefile՝ ֆայլի միայն այն տողերը, որոնց տողի սկզբում կա `33` թիվը, իսկ տողի վերջում `9`թիվը 
    * լրացնել հրամանը, այնպես որ ստանանք, թե քանի՞ նման տող կա
  * ցուցադրել էկրանին ՝~/largefile՝ ֆայլի վերևից 7-րդ տողը
    * լրացնել հրամանը, այնպես որ այդ տողը գրվի ՝~/lnum՝ ֆայլի մեջ
